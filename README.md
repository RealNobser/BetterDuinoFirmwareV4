...
## Why MarcDuinoV4?
The last update of the original firmware was made in 2018. Neils latest update was a minor change in mid 2022. His V3 software has about 80% of the original source in common, adding some features for the most recent MarcDuino boards (servo controller and EXT/AUX-Pin controls).
## Supported Board


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNzU1NzI4MjYsLTIxOTczOTIxOF19
-->